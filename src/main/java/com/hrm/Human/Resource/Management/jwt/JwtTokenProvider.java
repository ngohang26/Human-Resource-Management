...
public class JwtTokenProvider {
    ...
    private final SecretKey jwtSecret = Keys.secretKeyFor(SignatureAlgorithm.HS256); // Generate a new secret key
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .signWith(jwtSecret) // Use the new secret key
                .compact();
    }

    public Long getUserIdFromJWT(String token) {
        Claims claims = Jwts.parser()
                .setSigningKey(jwtSecret) // Use the new secret key
