...
public class EmployeeAllowanceController {
    ...
    @PreAuthorize("hasAuthority('ADD_EMPLOYEE_ALLOWANCE')")
    ...
    @PreAuthorize("hasAuthority('VIEW_EMPLOYEE_ALLOWANCE')")
    ...
    @PreAuthorize("hasAuthority('EDIT_EMPLOYEE_ALLOWANCE')")
    ...
    @PreAuthorize("hasAuthority('DELETE_EMPLOYEE_ALLOWANCE')")
